...
'''
parser = argparse.ArgumentParser(description='危险驾驶行为检测系统启动...')
...
# 图片增强
def picture_enhancement(lowlight_enhance):
...
# yolov5算法
def distraction_detection(im0s):
...
def main(_):
    ...
    predictor = dlib.shape_predictor('models/68_face_landmarks.dat')
